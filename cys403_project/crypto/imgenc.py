...
class ImageEncryptor:
    ...
    def __init__(self, key: bytes) -> None:
        ...
        """
        self.blocksize = 16  # AES has a fixed block size
        self._rounds = ROUND_SIZES[
            len(key)
        ]  # ONLY 16, 24, 32 ARE VALID OTHERWISE ERROR
        self._key = key
    ...
    def _key_expansion(self) -> list[bytes]:
        ...
        """
        nk = len(self.key) // 4  # length of key in multiples of 4
